...
def calculate(*args):
    try:
        ...
        # feet and meters are StringVar()s
    except ValueError:
        pass
...
# mainframe is set up to occupy the root window below its title
#        an internal buffer vvvvvvv
mainframe = ttk.Frame(root, padding=(3, 3, 12, 12))
mainframe.grid(column=0, row=0, sticky=(N, W, E, S))
# sticky =() if not specified, stretched to size of its cell
# with result that the "Feet to Meters" line is not distinct
# grid places it directlyinside your main application
